from apps import about,training,ais_update_train_data,ais_update_test_data,ais_test_email,pdf_ais
...
#LOGO_IMAGE  and title positioning ,  put in your own logo here!!
...
app.add_app("Summarize PDF", pdf_ais.app)
